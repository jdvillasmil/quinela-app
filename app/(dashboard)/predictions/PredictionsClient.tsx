...
import { Calendar, MapPin, Lock, CheckCircle, AlertCircle, Loader2, Save } from 'lucide-react'
    ...
    `}>
      ...
      <div className="flex items-center justify-center gap-3 px-4 py-3">
        ...
        <div className="flex-1 flex flex-col items-center gap-1.5 min-w-0">
          ...
          <span className="text-xs font-semibold text-navy text-center leading-tight truncate w-full text-center">
            {match.home_team}
          </span>
        </div>
...
export default function PredictionsClient({ groupData, groups }: Props) {
  ...
  return (
    <div className="space-y-5">
      {/* Page header */}
      <div>
        <h1 className="text-2xl font-bold text-navy">Predicciones de Grupos</h1>
        <p className="text-sm text-gray-500 mt-1">
          Ingresa el marcador que predices para cada partido. Los partidos bloqueados <Lock className="inline w-3 h-3" /> ya no admiten cambios.
        </p>
      </div>
